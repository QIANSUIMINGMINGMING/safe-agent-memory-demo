...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("conflict neighbors of row {}: {:#?}", row_b.value(), db.conflict_neighbors("design_claims", row_b)?);
    println!("support neighbors of row {}: {:#?}", row_c.value(), db.support_neighbors("design_claims", row_c)?);
    println!("support neighbors of row {}: {:#?}", row_d.value(), db.support_neighbors("design_claims", row_d)?);
    println!("extra rows for reference: a={}, e={}, f={}", row_a.value(), row_e.value(), row_f.value());
